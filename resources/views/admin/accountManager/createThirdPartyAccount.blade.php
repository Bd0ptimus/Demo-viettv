        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('admin.thirdParty.createAccount') }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <select name="userType" class="form-control @error('userType') is-invalid @enderror"
                                        ...
                                        <option value="0" label="Chọn loại tài khoản..." selected="selected"
                                            disabled hidden>Chọn loại tài khoản...</option>
                                        <option value="{{ VNOO_USER }}">VNOO</option>
                                        <option value="{{ GOVIET_USER }}">GO VIET</option>
                                        <option value="{{ M3U_USER }}">M3U</option>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="createdDate" type="date"
                                        ...
                                        name="createdDate" value="{{ old('createdDate') }}" required
                            ...
                            <div class="row mb-3">
                                <label for="interLink" class="col-md-4 col-form-label text-md-end">Link quốc tế
                                </label>

                                <div class="col-md-6">
                                    <input id="interLink" type="text"
                                        class="form-control @error('interLink') is-invalid @enderror" name="interLink"
                                        value="{{ old('interLink') }}" autocomplete="interLink">
                            ...
                            <div class="row mb-3">
                                <label for="tivimateAcc" class="col-md-4 col-form-label text-md-end">Tài khoản
                                    Tivimate/OTT</label>

                                <div class="col-md-6">
                                    <input id="tivimateAcc" type="text"
                                        class="form-control @error('tivimateAcc') is-invalid @enderror"
                                        name="tivimateAcc" value="{{ old('tivimateAcc') }}"
                                        autocomplete="tivimateAcc">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="numDevices" type="number"
                                        ...
                                        name="numDevices" value="{{ old('numDevices') }}" required
                                ...
                                <div class="col-md-6">
                                    <div class="d-flex justify-content-center">
                                        <input id="paidAmount" type="number"
                                            style="width:50%; margin:0px 5px 0px 0px;"
                                            class="form-control @error('numDevices') is-invalid @enderror"
                                            name="paidAmount" value="{{ old('paidAmount') }}"
                                            autocomplete="paidAmount">

                                        <select name="currency" style="width:50%; margin: 0px 5px 0px 0px;"
                                            class="form-control @error('active') is-invalid @enderror"
                                            id="currency">
                                            <option value="0" label="Chọn đơn vị..." selected="selected"
                                                disabled hidden>Chọn đơn vị...</option>
                            ...
                            <div class="row mb-3">
                                <label for="manager" class="col-md-4 col-form-label text-md-end">Người quản lý<span
                                        class="text-danger">(*)</span></label>

                                <div class="col-md-6">
                                    <select name="manager" style="width:50%; margin: 0px 5px 0px 0px;"
                                        class="form-control @error('manager') is-invalid @enderror" id="manager">
                                        <option value="0" label="Chọn người quản lý..." selected="selected"
                                            disabled hidden>Chọn người quản lý...</option>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="boxAssign" type="checkbox"
                                        class=" @error('note') is-invalid @enderror" style="margin-top: 13px;"
                                        name="boxAssign" autocomplete="note">
                            ...
                            <div class="row mb-3">
                                <label for="boxInfo" class="col-md-4 col-form-label text-md-end">Thông tin
                                    box</label>
